...
export const AGENTS = [
  ...
  {
    id: 'counterfeit',
    name: 'Counterfeit-Vision Agent',
    short: 'VISION',
    icon: 'ScanEye',
    color: '#F5A524',
    angle: 214,
    desc: 'Detects fake currency from imagery',
...
export const KPIS = [
  ...
  { id: 'notes', label: 'Counterfeit notes flagged', value: 367, tone: 'amber', icon: 'Banknote' },
]

export const INCIDENT_FEED = [
  { id: 1, sev: 'high', tag: 'DIGITAL-ARREST', text: 'Forwarded call · South Delhi', time: 'now', live: true },
  { id: 2, sev: 'med', tag: 'UPI-FRAUD', text: 'QR swap attempt · Pune', time: '2m' },
  { id: 3, sev: 'low', tag: 'PHISHING', text: 'Fake KYC SMS cluster · Jaipur', time: '4m' },
  { id: 4, sev: 'high', tag: 'MULE-RING', text: 'New cluster surfaced · Mumbai', time: '7m' },
  { id: 5, sev: 'med', tag: 'COUNTERFEIT', text: '₹500 note flagged · Patna', time: '9m' },
  { id: 6, sev: 'low', tag: 'LOAN-SCAM', text: 'Predatory app alert · Surat', time: '12m' },
  { id: 7, sev: 'med', tag: 'SIM-SWAP', text: 'OTP intercept attempt · Noida', time: '15m' },
]
